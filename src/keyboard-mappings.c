...
const mapping mappings[] = {
    ...
    {
        .from = {.code = KEY_BACKSLASH, .modifiers = {.alt = LEFT, .shift = EITHER}},
        .to = {.code = KEY_102ND, .modifiers = {.shift = LEFT}},
    },
    {
        .from = {.code = KEY_Z, .modifiers = {.alt = RIGHT}},
        .to = {.code = KEY_102ND, .modifiers = {}},
    },
    {
        .from = {.code = KEY_Z, .modifiers = {.alt = RIGHT, .shift = EITHER}},
        .to = {.code = KEY_102ND, .modifiers = {.shift = LEFT}},
    },
    {
        .from = {.code = KEY_RIGHTSHIFT, .modifiers = {}},
        .to = {.code = KEY_RO, .modifiers = {}},
    },
    {
